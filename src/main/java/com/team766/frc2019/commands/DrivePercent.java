...
public class DrivePercent extends Subroutine {
    ...
    protected void subroutine() {
        ...
        Robot.drive.setDrive(0.025, 0.025, ControlMode.PercentOutput);
        waitForSeconds(5.0);
        System.out.println("0.05");
        Robot.drive.setDrive(0.05, 0.05, ControlMode.PercentOutput);
        waitForSeconds(5.0);
        System.out.println("0.1");
        Robot.drive.setDrive(0.1, 0.1, ControlMode.PercentOutput);
        waitForSeconds(5.0);
