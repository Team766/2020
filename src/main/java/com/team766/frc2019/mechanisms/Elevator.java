...
public class Elevator extends Mechanism {
    ...
    private static int MIN_LOWER_HEIGHT = 40000;
    private static int VERY_CLOSE_MIN_LOWER_HEIGHT = 100000;
	private static int NEAR_MIN_LOWER_HEIGHT = 400000;
    ...
    private static int NEAR_MIN_UPPER_HEIGHT = 200000;
    ...
    private static int MAX_COMBINED_HEIGHT = MAX_LOWER_HEIGHT + MAX_UPPER_HEIGHT;
